    ...
    <>
      <footer className="border-t border-border bg-muted/50">
        <div className="max-w-[1600px] mx-auto px-4 py-6">
          ...
          {/* Grid 3 colunas — identidade + contacto + informações */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">

            {/* Col 1 — Identidade */}
            <div className="flex flex-col gap-2.5">
              <div className="flex items-center gap-2">
                <img src={vrcfShield} alt="VRCF Informática &amp; Segurança" className="h-8 w-auto" />
                <div>
            ...
            <div className="flex flex-col gap-2">
              <p className="text-xs font-semibold uppercase tracking-wide mb-0.5">Contacto</p>
              <a href="tel:+351911564243" className="flex items-center gap-2 text-xs text-muted-foreground hover:text-primary transition-colors">
                <Phone className="h-3.5 w-3.5 shrink-0" /> +351 911 564 243
              </a>
              <a href="mailto:geral@vrcf.pt" className="flex items-center gap-2 text-xs text-muted-foreground hover:text-primary transition-colors">
            ...
            {/* Col 3 — Informações (3 + 3 em 2 subcolunas) */}
            <div className="flex flex-col gap-2">
              <p className="text-xs font-semibold uppercase tracking-wide mb-0.5">Informações</p>
              <div className="grid grid-cols-2 gap-x-4 gap-y-2">
                ...
                <Link to="/politica-de-privacidade" className="text-xs text-muted-foreground hover:text-primary transition-colors">Privacidade</Link>
                ...
                <Link to="/politica-de-cookies" className="text-xs text-muted-foreground hover:text-primary transition-colors">Cookies</Link>
        ...
        <div className="border-t border-border/60">
          <div className="max-w-[1600px] mx-auto px-4 py-2.5 flex flex-col sm:flex-row items-center justify-between gap-2">
