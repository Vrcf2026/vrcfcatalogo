CREATE OR REPLACE FUNCTION public.search_products(p_query text, p_mundo text DEFAULT NULL::text, p_category text DEFAULT NULL::text, p_family_id uuid DEFAULT NULL::uuid, p_type_id uuid DEFAULT NULL::uuid, p_brand_id uuid DEFAULT NULL::uuid, p_brand text DEFAULT NULL::text, p_limit integer DEFAULT 24, p_offset integer DEFAULT 0, p_order_by text DEFAULT 'created_at'::text, p_order_asc boolean DEFAULT false)
...
CREATE OR REPLACE FUNCTION public.get_search_category_counts(p_query text, p_mundo text DEFAULT NULL::text)
